...
CREATE TABLE IF NOT EXISTS `move_smart`.`applications` (
  ...
  `ApplicationType` ENUM('MissionNote', 'SparePartWithdrawApplication', 'ConsumableWithdrawApplication', 'SparePartPurchaseOrder', 'ConsumablePurchaseOrder', 'MaintenanceApplication') NOT NULL,
